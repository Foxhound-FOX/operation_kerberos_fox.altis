...
If (((getMarkerpos "respawn_west_airport") distance2D [0,0,0])>100) then {
    [getMarkerPos "respawn_west_airport",localize LSTRING(AIRPORT),["default","infanterie"],{true},[]] call FUNC(registerTeleportTarget);
    [getMarkerPos "respawn_west_airport",localize LSTRING(AIRPORT),["default","infanterie"],{true},[]] call FUNC(registerTeleportPosition);
};

If (((getMarkerpos "respawn_west_boathouse_west") distance2D [0,0,0])>100) then {
    [getMarkerPos "respawn_west_boathouse_west",localize LSTRING(BOATHOUSE_WEST),["default","infanterie","ship"],{true},[]] call FUNC(registerTeleportTarget);
    [getMarkerPos "respawn_west_boathouse_west",localize LSTRING(BOATHOUSE_WEST),["default","infanterie","ship"],{true},[]] call FUNC(registerTeleportPosition);
};

If (((getMarkerpos "respawn_west_boathouse_east") distance2D [0,0,0])>100) then {
    [getMarkerPos "respawn_west_boathouse_east",localize LSTRING(BOATHOUSE_EAST),["default","infanterie","ship"],{true},[]] call FUNC(registerTeleportTarget);
    [getMarkerPos "respawn_west_boathouse_east",localize LSTRING(BOATHOUSE_EAST),["default","infanterie","ship"],{true},[]] call FUNC(registerTeleportPosition);
};
